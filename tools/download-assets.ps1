...
$items = @(
  ...
  @('Galaxy Tab S11 Ultra','assets\products\tabs\galaxy-tab-s11-ultra.png','https://images.samsung.com/is/image/samsung/p6pim/br/sm-x930nzahzto/gallery/br-galaxy-tab-s11-ultra-sm-x930-sm-x930nzahzto-548653896?$1164_776_PNG$'),
  ...
  @('Galaxy Book Go (14")','assets\products\bookgo\galaxy-book-go.png','https://images.samsung.com/is/image/samsung/p6pim/br/np340xla-k09br/gallery/br-galaxy-book-go-np340xlaa-552529-np340xla-k09br-547340213?$1164_776_PNG$'),
