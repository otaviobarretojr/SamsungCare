...
$items = @(
  ...
  @('Galaxy Tab S11 Ultra','assets\products\tabs\galaxy-tab-s11-ultra.png','https://samsungbrshop.vtexassets.com/arquivos/ids/291276-800-auto?v=639197229859770000'),
  @('Galaxy Tab A11+ 5G','assets\products\taba\galaxy-tab-a11-plus-5g.png','https://samsungbrshop.vtexassets.com/arquivos/ids/291328-800-auto?v=639197235689530000'),
